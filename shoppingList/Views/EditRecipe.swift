...
struct EditRecipe: View {
    ...
    @State private var addZutatButton = false //Variable, um das Sheet für das Hinzufügen der Zutat anzuzeigen
    @State var selectedPhoto: PhotosPickerItem? //Speichert das ausgesuchte Foto des Nutzers
    
    @Bindable var item: Recipe //Referenziert das angetippte Rezept, um es zu editieren
    ...
    var body: some View {
        ...
        .padding(20)
        .navigationTitle("\(item.name)") //Name des Rezeptes als Titel anzeigen
