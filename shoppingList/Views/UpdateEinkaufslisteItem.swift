...
struct UpdateEinkaufslisteItem: View {
    
    @Environment(\.dismiss) var dismiss
    @Environment(\.modelContext) var context
    
    @Bindable var item: ShoppingListItem //Das aktuelle Listenitem wird durch diese Variable repräsentiert
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 5) {
            ...
            VStack(alignment: .leading) {
                ...
                .padding()
                .background(Color("greyBG")) // Hintergrundfarbe des Textfelds festlegen
                .cornerRadius(8) // Optional: Abrunden der Ecken des Textfelds
            }.padding(.bottom, 10)
        ...
        .padding(20)
        .navigationTitle("Produkt ändern")
